...
public class TwoCharacters
{
	...
	public static String pickColor() // return color - put in String
	{
		String color;
		Scanner keyboard = new Scanner(System.in);
		System.out.print("Choose a color for your first character >> ");
		color = keyboard.nextLine();
		return color;
	}
	
		public static String pickColor2() // return color - put in String
	{
		String color;
		Scanner keyboard = new Scanner(System.in);
